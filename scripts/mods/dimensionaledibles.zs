...
recipes.addShaped("CTNetherCake", <dimensionaledibles:nether_cake>, [[<minecraft:flint>, <minecraft:flint>, <minecraft:flint>], [<minecraft:ender_pearl>, <minecraft:cake>, <minecraft:ender_pearl>], [<ore:ingotSteel>, <ore:ingotSteel>, <ore:ingotSteel>]]);