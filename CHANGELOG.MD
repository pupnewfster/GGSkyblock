...
- Use new features in Compat skills, to allow use of the alchemy array, but not allow use of the crafting only tools otherwise.
...
Updated
  ...
  - Botania Needs These Things! (1.1.1 to 1.1.2)
