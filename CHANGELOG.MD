...
Updated
  ...
  - Armory Expansion (0.2.0 to 1.3.1)
  - Aroma1997Core (2.0.0.1.b163 to 2.0.0.2.b165)
  - Aroma Backup(3.0.0.0.b117 to 3.0.0.0.b118)
  - Astral Sorcery (1.10.11 to 1.10.19)
  ...
  - Better Questing - Standard Expansion (3.4.151 to 3.4.159)
  ...
  - In Control (3.9.2 to 3.9.10)
  - Incorporeal (1.0.3 to 1.1.4)
  - InWorldCrafting (1.0.0 to 1.2.0)
  - JAOPCA (2.2.8.100 to 2.2.8.103)
  - JEI (4.14.4.264 to 4.15.0.283)
  - JourneyMap (5.5.3 to 5.5.5b7)
  - Just Enough Energistics (1.0.6 to 1.0.7)
  - Just Enough Throwing In Fluids (1.3.0 to 1.4.2)
  - LittleTiles (1.5.0-pre125 to 1.5.0-pre135)
  - LootTweaker (0.0.8 to 0.0.10)
  - Mantle (1.3.3.42 to 1.3.3.55)
  - McJtyLib (3.1.1 to 3.5.3)
  - Mekanism (9.4.13.349 to 9.7.8.379)
  - Mekanism Generators (9.4.13.349 to 9.7.8.379)
  - MetalChests (4.0.1 to 5.1.2)
  ...
  - p455w0rd's Library (2.0.36 to 2.2.151)
  - Placebo (1.5.1 to 1.6.0)
  - PlusTiC (7.0.5.0 to 7.1.0.0)
  - Progressive Bosses (1.4.1 to 1.5.0)
  - ProjectE (1.4.0 to 1.4.1)
  - RandomPatches (1.13.0.1 to 1.16.3.1)
  - RandomPatches Integration (1.3.0.0 to 1.5.0.0)
  - RandomTweaks (2.4.3.1 to 2.6.0.0)
  ...
  - Smooth Font (2.0-alpha-6 to 2.0)
  - Tech Reborn (2.20.11.929 to 2.22.1.979)
  - Thaumic Additions (12r to 18r)
  - Thaumic Bases Unofficial (3.3.310.5r to 3.3.350.6r)
  ...
  - Unlimited Chisel Works (0.2.0 to 0.2.2)
  - Visuals (3r to 6r)
