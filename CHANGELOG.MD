...
Updated
  ...
  - Armory Expansion (0.2.0 to 1.1.10)
  ...
  - Construct's Armory (1.2.3 to 1.2.3.3)
  - Cosmetic Armor Reworked (v4 to v4a)
  - CraftTweaker (4.1.14 to 4.1.17)
  - CreativeCore (1.9.39 to 1.9.43)
  ...
  - RandomTweaks (2.4.3.1 to 2.5.0.3)
  ...
  - Thaumic JEI (1.5.5-23 to 1.5.8-26)
