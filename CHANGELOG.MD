...
### 1.5 (IN DEVELOPMENT)
- WARNING: An update to Botania Needs These Things, change the registry name of the mana charger. So before updating I recommend removing any items from it and breaking the mana chargers.
  - Quest for mana charger updated to have the proper item again. Recommended as with whenever quests change to use `/bq_admin default load` to load any changes I have made to the quest book.
- Warning: Black Quartz block id has changed, if you used any or have any blocks of it I recommend converting them to EMC and then making them again after the update.
...
- Changes `allowEmissiveItems` to true as Mekanica does not have issues rendering some items.
- Enabled `EnableAmbientLighting` for Mekanica as it does not have the performance issues Mekanism had with this option enabled.
- Disable Mekanica multiblock's from spawning particles on forming (they will however display a message on the action bar when the multiblock was completed.) This should improve FPS especially on loading up very progressed worlds in single player.
...
Added
  ...
  - Thaumic Wonders
Updated
  - Actually Additions (r145 to r146)
  - Anger Management (1.0.0 to 1.0.2)
  - Animus (2.1.0 to 2.1.2)
  - AppleCore (3.1.4 to 3.2.0)
  - Armory Expansion (0.2.0 to 1.1.5)
  - Armor Toughness Bar (2.0 to 2.1)
  - Aroma1997Core (2.0.0.1.b163 to 2.0.0.2.b165)
  - Astral Sorcery (1.10.11 to 1.10.12)
  - Auxillium Equivalence (1.3.0 to 1.3.2)
  - B.A.S.E (3.11.0 to 3.12.0)
  - Baubley Heart Canisters (1.2.1 to 1.2.3)
  - Better Advancements (0.0.17.74 to 0.1.0.77)
  - Better Builder's Wands (0.13.0.267 to 0.13.2.271)
  - Better Questing (3.5.291 to 3.5.296)
  - Better Questing - Standard Expansion (3.4.151 to 3.4.154)
  - Botania (1.10-359 to 1.10-360)
  - Botania Needs These Things! (1.1.1 to 2.1)
  - CompatSkills (1.13.4 to 1.15.0)
  - CraftTweaker (4.1.14 to 4.1.17)
  - CreativeCore (1.9.39 to 1.9.41)
  - Ender IO (5.0.40 to 5.0.43)
  - Ender IO Endergy (5.0.40 to 5.0.43)
  - Ender Tweaker (1.1.3 to 1.1.6)
  - EnderCore (0.5.45 to 0.5.52)
  - Extended Crafting (1.5.2 to 1.5.3)
  - Extra Botany (1.1-51 to 1.1-53-fix)
  - FastFurnace (1.2.1 to 1.2.2)
  - FastWorkbench (1.6.0 to 1.6.1)
  - FindMe (1.0.2-6 to 1.1.0-8)
  - Forge (14.23.5.2814 to 14.23.5.2824)
  - Garbage Bins (1.1.0 to 1.1.1)
  - Gas Conduits (1.0.0 to 1.1.0)
  - Hammer (Lib) Core (2.0.4.2 to 2.0.4.4)
  - In Control (3.9.2 to 3.9.6)
  - Incorporeal (1.0.3 to 1.0.4)
  - InWorldCrafting (1.0.0 to 1.2.0)
  - JAOPCA (2.2.8.100 to 2.2.8.101)
  - JEI (4.14.4.264 to 4.15.0.273)
  - JourneyMap (5.5.3 to 5.5.4)
  - Just Enough Throwing In Fluids (1.3.0 to 1.3.1)
  - LittleTiles (1.5.0-pre125 to 1.5.0-pre130)
  - LootTweaker (0.0.8 to 0.0.9)
  - Mantle (1.3.3.42 to 1.3.3.49)
  - ModTweaker (4.0.16 to 4.0.17)
  - MTLib (3.0.5 to 3.0.6)
  - Mystical Agriculture (1.7.1 to 1.7.3)
  - OldJavaWarning (1.0.9 to 1.0.10)
  - OpenBlocks Elevator (1.3.6 to 1.3.8)
  - Overloaded Armor Bar (1.0.2 to 1.0.4b)
  - Placebo (1.5.1 to 1.6.0)
  - PlusTiC (7.0.5.0 to 7.0.5.2)
  - RandomPatches (1.13.0.1 to 1.15.0.2)
  - RandomPatches Integration (1.3.0.0 to 1.4.0.0)
  - RandomTweaks (2.4.3.1 to 2.5.0.2)
  - Reborn Core (3.13.4.419 to 3.13.9.433)
  - Reskillable (1.12.3 to 1.12.5)
  - Smooth Font (2.0-alpha-6 to 2.0-alpha-9)
  - Tech Reborn (2.20.11.929 to 2.22.0.968)
  - Thaumic Additions (12r to 13r)
  - Thaumic Bases Unofficial (3.3.310.5r to 3.3.345.6r)
  - Thaumic Energistics (2.1.1 to 2.2.1)
  - Thaumic JEI (1.5.5-23 to 1.5.6-24)
  - Thaumic Restoration (1.2.1a to 1.3.1)
  - Tinkers' Construct (2.12.0.115 to 2.12.0.135)
  - Tinkers' Complement (0.3.0 to 0.3.2)
  - Tinker's JEI (1.0 to 1.1)
  - TipTheScales (1.0.3 to 1.0.4)
  - Visuals (3r to 6r)
Removed
  - JourneyMapFixer (As it is no longer needed with the journeymap update)
Replaced
  - Mekanism with Mekanica
  - Mekanism Generators with Mekanica: Generators
